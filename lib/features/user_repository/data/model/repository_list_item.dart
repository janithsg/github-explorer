class RepositoryListItem {
  ...
  RepositoryListItem.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
  ...
  static List<RepositoryListItem> fromJsonArray(dynamic jsonArray) {
    final List<dynamic> list = jsonArray;
    return list.map((jsonObject) => RepositoryListItem.fromJson(jsonObject)).toList();
  }
}
